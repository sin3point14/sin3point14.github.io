      ...
      <div className="inner">
        <StyledText>
          <div>
            ...
            <p>
              I participate(and win!) a lot of CTFs which have greatly contributed to my knowledge in 
              information security, mainly the fields of reverse engineering and binary exploitation.
